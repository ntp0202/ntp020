...
template <typename T>
int searchThuVien(T arr[], int arrSize, T x) {
...
int main() {
    ...
    print(arr1, arrSize); cout << "    Ham cua sinh vien\n";
    print(arr2, arrSize); cout << "    Ham cua thu vien\n";
    ...
    int index1 = LinearSearch(arr3, arrSize, 25);
    int index2 = searchThuVien(arr3, arrSize, 25);
    ...
    //int index1 = BinarySearch(arr3, arrSize, 24);
    //int index2 = searchThuVien(arr3, arrSize, 24);
    //cout << index1 << "    Ham sinh vien\n";
    //cout << index2 << "    Ham thu vien\n";
    ...
    //int index1 = BinarySearch(arr3, arrSize, 6);
    //int index2 = searchThuVien(arr3, arrSize, 6);
    //cout << index1 << "    Ham sinh vien\n";
    //cout << index2 << "    Ham thu vien\n";
